...
- (UIButton *)deleleBtn{
    if (!_deleleBtn) {
        ...
        [deleleBtn setImage:[UIImage imageNamed:@"delete@2x"] forState:UIControlStateNormal];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (buttonIndex == 1) {
//        
//        [HTTPMethod gainDataRequestByURLString:[NSString stringWithFormat:@"%@%@", SERVER_URL, DeletePhotoURL] BodyDictionary:@{@"ids" : _photoId} WithDataBlock:^(id data) {
//            if ([[data objectForKey:@"res_type"] isEqualToString:@"success"]) {
...
//                }
//            }else{
//                [self alertControllerWithMessage:[NSString stringWithFormat:@"%@", [data objectForKey:@"lyrss_msg"]]];
//            }
//        }];
//       
    }
