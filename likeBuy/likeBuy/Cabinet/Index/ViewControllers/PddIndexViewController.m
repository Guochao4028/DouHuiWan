...
@interface PddIndexViewController ()<NavigationViewDelegate, XLPageViewControllerDelegate,XLPageViewControllerDataSrouce>
...
@implementation PddIndexViewController
...
- (UIViewController *)pageViewController:(XLPageViewController *)pageViewController viewControllerForIndex:(NSInteger)index {
    PddResultsListViewController *vc = [[PddResultsListViewController alloc] init];
    vc.model = self.optArray[index];
...
-(UIImageView *)heardImageView{
    if (_heardImageView == nil) {
        ...
        _heardImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, y, ScreenWidth, 132)];
         [_heardImageView setImage:[UIImage imageNamed:@"PddBanner"]];
    }
